    ...
    <div className="min-h-screen relative">
      ...
      <div className="space-y-20 relative -mt-20 pt-20">
        ...
        <section className="text-center w-full relative pt-2 lg:pt-4 pb-12 lg:pb-16 overflow-hidden" style={{ minHeight: '600px' }}>
          ...
          <div style={{ width: '100%', height: '600px', position: 'absolute', top: 0, left: 0, zIndex: 0, pointerEvents: 'none', mixBlendMode: 'screen' }}>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 space-y-6">
            ...
            <div className="flex justify-center mb-4">
              <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-primary/20 via-accent/20 to-primary/20 border border-primary/30 backdrop-blur-xl shadow-lg animate-fade-in hover:scale-105 transition-transform duration-300">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight leading-tight">
              <span className="block text-slate-100 animate-slide-up">Transform Your</span>
              <span className="block relative mt-2">
                <span className="bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">
                  Images with AI
                </span>
                {/* Animated underline */}
                <span className="absolute -bottom-2 left-1/2 -translate-x-1/2 h-1 w-32 bg-gradient-to-r from-transparent via-primary to-transparent animate-scale-pulse" />
              </span>
            </h1>
            
            <p className="text-lg sm:text-xl md:text-2xl text-slate-300 max-w-3xl mx-auto leading-relaxed animate-fade-in" style={{ animationDelay: '0.2s' }}>
        ...
        {/* Bento Grid Section */}
        <section className="relative space-y-8 px-4 sm:px-6 lg:px-8 overflow-hidden z-10">
          {/* Floating decorative elements */}
          <div className="absolute top-10 left-10 w-20 h-20 bg-primary/10 rounded-full blur-2xl animate-pulse-slow pointer-events-none z-0" style={{ animationDelay: '0s' }} />
          <div className="absolute bottom-20 right-10 w-32 h-32 bg-accent/10 rounded-full blur-3xl animate-pulse-slow pointer-events-none z-0" style={{ animationDelay: '1.5s' }} />
          <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-primary/5 rounded-full blur-xl animate-float pointer-events-none z-0" style={{ animationDelay: '3s' }} />
          
          <div className="text-center space-y-4 mb-16 relative z-20">
            <div className="inline-block mb-4">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-primary/20 via-accent/20 to-primary/20 border border-primary/30 text-primary text-sm font-semibold backdrop-blur-sm animate-fade-in">
                <Sparkles className="h-4 w-4 animate-spin-slow" style={{ animationDuration: '3s' }} />
        ...
        {/* Features Grid */}
        <section id="features" className="space-y-16 relative px-4 sm:px-6 lg:px-8 overflow-hidden z-10">
          {/* Animated background shapes */}
          <div className="absolute -top-20 -right-20 w-96 h-96 bg-accent/5 rounded-full blur-3xl animate-pulse-slow pointer-events-none z-0" />
          <div className="absolute -bottom-20 -left-20 w-96 h-96 bg-primary/5 rounded-full blur-3xl animate-pulse-slow pointer-events-none z-0" style={{ animationDelay: '2s' }} />
          
          <div className="text-center space-y-6 relative z-20">
            <div className="inline-block">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-accent/20 via-primary/20 to-accent/20 border border-accent/30 text-accent text-sm font-semibold backdrop-blur-sm">
        ...
        <section className="relative px-4 sm:px-6 lg:px-8 z-10">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-primary/15 via-accent/15 to-primary/15 rounded-3xl blur-3xl opacity-60 animate-pulse-slow z-0" />
          
          {/* Floating geometric shapes */}
          <div className="absolute -top-10 -left-10 w-40 h-40 border-2 border-primary/20 rounded-full blur-xl animate-float pointer-events-none z-0" />
          <div className="absolute -bottom-10 -right-10 w-60 h-60 border-2 border-accent/20 rounded-full blur-xl animate-float pointer-events-none z-0" style={{ animationDelay: '2s' }} />
          
          <div className="relative bg-gradient-to-br from-slate-800/95 via-slate-800/90 to-slate-800/95 backdrop-blur-xl rounded-3xl p-8 md:p-12 lg:p-16 border-2 border-slate-700/70 shadow-2xl shadow-black/50 overflow-hidden group z-20">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center relative z-30">
              ...
              <div>
                ...
                <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-4 bg-gradient-to-r from-slate-100 via-primary to-slate-100 bg-clip-text text-transparent relative">
                  <span className="relative inline-block">
                    Why Choose VisionAI?
                    <span className="absolute inset-0 bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent opacity-30 blur-xl">
                      Why Choose VisionAI?
                    </span>
                  </span>
                </h2>
        ...
        {/* CTA Section */}
        <section className="relative text-center px-4 sm:px-6 lg:px-8 z-10">
          {/* Background glow effect */}
          <div className="absolute inset-0 bg-gradient-to-br from-primary/25 via-accent/25 to-primary/25 rounded-3xl blur-3xl opacity-60 animate-pulse-slow z-0" />
          
          {/* Animated border rings */}
          <div className="absolute inset-0 rounded-3xl border-2 border-primary/20 animate-spin-slow pointer-events-none z-0" style={{ animationDuration: '20s' }} />
          <div className="absolute inset-2 rounded-3xl border border-accent/10 animate-spin-slow pointer-events-none z-0" style={{ animationDuration: '15s', animationDirection: 'reverse' }} />
          
          <div className="relative bg-gradient-to-br from-slate-800/95 via-slate-800/90 to-slate-800/95 backdrop-blur-xl rounded-3xl p-12 lg:p-16 border-2 border-primary/40 shadow-2xl shadow-primary/30 overflow-hidden group z-20">
            {/* Animated gradient overlay */}
            ...
            <div className="absolute top-1/4 left-1/3 w-2 h-2 bg-accent rounded-full opacity-40 animate-pulse" style={{ animationDelay: '3s' }} />
            
            <div className="max-w-3xl mx-auto space-y-8 relative z-30">
              <div>
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-primary/20 to-accent/20 border border-primary/30 text-primary text-xs font-semibold mb-6 backdrop-blur-sm">
                  <Rocket className="h-3 w-3 animate-bounce" />
                  <span>Get Started Now</span>
                </div>
                <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold bg-gradient-to-r from-slate-100 via-primary to-slate-100 bg-clip-text text-transparent mb-4 relative">
                  <span className="relative inline-block">
