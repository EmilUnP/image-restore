  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <div className="space-y-20 py-8 lg:py-12 relative">
        ...
        {/* Features Grid */}
        <section id="features" className="space-y-12 relative px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {getFeatures(onFunctionSelect).map((feature, index) => {
            ...
            return (
              <Card
                key={index}
                className="group relative overflow-hidden hover:shadow-lg transition-all duration-300 cursor-pointer border border-slate-700/70 hover:border-primary/60 bg-slate-800/50 hover:bg-slate-800"
              ...
              >
                ...
                <CardContent className="relative z-10 p-6 pt-0">
                  <Button
                    variant="ghost"
                    size="sm"
                    className="w-full group-hover:text-primary font-medium"
                  >
                    Try Now
        ...
        <section className="relative px-4 sm:px-6 lg:px-8">
          <div className="bg-slate-800/50 rounded-3xl p-8 md:p-12 lg:p-16 border border-slate-700/60">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-slate-800 rounded-3xl p-8 border border-slate-700/60">
                <div className="space-y-6">
                  {[
                    ...
                    return (
                      <div key={idx} className="flex items-center gap-4 p-4 rounded-2xl hover:bg-slate-700/50 transition-all duration-300">
        ...
        <section className="relative text-center px-4 sm:px-6 lg:px-8">
          <div className="bg-slate-800/50 rounded-3xl p-12 lg:p-16 border border-slate-700/60">
